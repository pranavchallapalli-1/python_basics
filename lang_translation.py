...
import base64
df=pd.read_csv(r"D:\Naresh_IT\coding\ml_nlp_assignment\nlp_lan_transalation_ass\language.csv")
...
st.title("Language-Translataion ")
input_text=st.text_area("Hi please enter text here to Translate",height=100)
